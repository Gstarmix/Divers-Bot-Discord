...
class CommandCheck(commands.Cog):
    def __init__(self, bot):
        ...
        self.allowed_commands = {
            ...
            LOG_CHANNEL_ID: [],
            MUDAE_CONTROL_CHANNEL_ID: [],
            MUDAE_WAIFUS_CHANNEL_2_ID: ["$waifu", "$waifua", "$waifug", "$waifub", "$husbando", "$husbandoa", "$husbandog", "$husbandob", "$marry", "$marrya", "$marryg", "$marryb", "$w", "$h", "$m", "$wa", "$ha", "$ma", "$wg", "$hg", "$mg", "$us", "$usestack", "$tu", "$timersup", "$mu", "$marryup", "$ku", "$kakeraup", "$vote", "$daily", "$rolls", "$dk", "$dailykakera"],
