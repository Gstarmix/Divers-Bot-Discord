...
class CommandCheck(commands.Cog):
    def __init__(self, bot):
        ...
        self.allowed_commands = {
            ...
            MUDAE_POKESLOT_CHANNEL_ID: ["$pokemon", "$pokedex", "info pokedex arguments", "$sortpkm", "$shinyhunt", "$autorelease", "$release", "$releaseall", "$pokemode", "$pokerank", "$pokeserv", "$pokelike", "$pokelikelist", "$togglepokelike", "$pokeprofile"],
