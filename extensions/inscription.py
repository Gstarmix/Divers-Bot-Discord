...
class Inscription(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        try:
            ...
            await thread.send(f"<@{message.author.id}> Merci d'avoir partagé la capture d'écran ! Votre inscription au concours est en cours de vérification. <@200750717437345792> procédera maintenant à sa validation.")
