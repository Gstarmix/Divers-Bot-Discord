...
class Question(commands.Cog):
    def __init__(self, bot):
        ...
        self.interrogative_words = ["qui", "que", "quoi", "où", "quand", "pourquoi", "comment", "est-ce", "qu'est-ce", "combien", "quel", "quelle", "quels", "quelles", "lequel", "laquelle", "lesquels", "lesquelles", "d'où", "jusqu'où", "depuis", "jusqu'", "à", "de", "en"]
    ...
    def send_error_message(self, error_type, thread):
        ...
        if error_type == "starts_with_interrogative_word":
            return f"{thread.owner.mention} Votre titre ne commence pas par un mot interrogatif. Il doit commencer par un mot comme `qui`, `que`, `quoi`, `où`, `quand`, `pourquoi`, `comment`, `est-ce`, `qu'est-ce`, `combien`, `quel`, `quelle`, `quels`, `quelles`, `lequel`, `laquelle`, `lesquels`, `lesquelles`, `d'où`, `jusqu'où`, `depuis`, `jusqu'`, `à`, `de`, `en`. Veuillez le changer et écrire votre nouveau titre à la suite de ce message."
